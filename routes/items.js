...
// route is GET /items, It gets all items, if I was adding auth it would be Public
router.get('/', (req, res) => {
  Item.find()
  .then(items => res.json(items))
})

// route is POST /items, Creates an item, if I was adding auth it would be Private
router.post('/', (req, res) => {
